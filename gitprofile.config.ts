...
const CONFIG = {
  github: {
    username: 'cytostatic', // Your GitHub org/user name. (This is the only required config)
  },
  /**
    ...
    github: {
      ...
      automatic: {
        ...
        exclude: {
          ...
          projects: ['cytostatic/cytostatic'], // These projects will not be displayed. example: ['arifszn/my-project1', 'arifszn/my-project2']
        },
      },
      manual: {
  ...
  seo: {
    title: 'Portfolio of Raphael Staerk',
    description: '',
    imageURL: '',
  },
  social: {
    linkedin: 'raphael-staerk',
    twitter: '',
    mastodon: '',
    researchGate: '',
    facebook: '',
    ...
    skype: '',
    telegram: '',
    website: 'https://cytostatic.dev',
    phone: '',
    email: 'raphael@cytostatic.dev',
  },
  resume: {
